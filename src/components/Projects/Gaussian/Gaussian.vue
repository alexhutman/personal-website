  ...
  <header-page :page-title="title">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="explanation col-md-4" style="width: 100vw !important;
          height: 78vh !important;">
              <div id="gaussianCarousel" class="reveal">
                  <div class="slides">
                    <section>
                    <h5>How does it work?</h5>
                      <img src="assets/gaussian/matrix.png" class="img-fluid"
                      alt="...">
                    <!--
